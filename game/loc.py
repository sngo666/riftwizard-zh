...
upgrades = {
    ...
    "Damage": "伤害",
    "Range": "射程",
    "Toxic Shift": "Toxic Shift",  # Bloodshift 好理解，什么叫毒转移啊你告诉我
    "Chain Fireball": "连锁火球",
    ...
    "Fae Wall": "仙灵祝福",
    "Endless Wall": "无尽冰幕",
    "Pyrostatic Watcher Form": "电焰形态",
    "Void Watcher Form": "虚空形态",
    "Chain Watcher Form": "连锁形态",
    "Cheat Fate": "瞒天过海",
    "Final Burst": "高压过载",
    "Drakebirth": "巨龙降生",
    "Pyrostatics": "升压爆燃",
...
equipments = {
    ...
    "Storm Oculus": "风暴眼眸",
    "Void Oculus": "虚空眼眸",
    "Pyrostatic Oculus": "热电眼眸",
    "Twilight Oculus": "暮光眼眸",
    "Crystal Oculus": "水晶眼眸",
    "Purity Oculus": "圣洁眼眸",
    "Arcane Amplifier": "奥术增幅杖",
    "The Flamenweaver": "织火杖",
    "Treelord Staff": "树林领主手杖",
    "Aetherlord Staff": "以太领主手杖",
    "Filthlord Staff": "污秽领主手杖",
    "Flaming Claw Staff": "焰爪手杖",
    "Icy Claw Staff": "冰爪手杖",
    "Scepter of Mischief": "戏法权杖",
    "Drakenstaff": "巨龙手杖",
    "The Purifier": "净焚",
    "Silvermelt": "熔银",
    "Sorcwinter": "冬巫",
